...
#################################################################################################################################
#               Domain age & Domain registration age 
#################################################################################################################################

def domain_info(key, domain):
    try:
        r = 'whois'
        ...
        if res.status_code == 200:
            ...
            if int(data['status']) == 0:
                ...
                domain_age = (today - date_created).days
                domain_registration_length = (date_expires - date_created).days
